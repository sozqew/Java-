...
public class ArrayListExample {
	public static void main(String[] args) {
		// String 으로 된 여러 개의 객체를 Array 처럼 사용하도록 ArrayList 객체를 생성
		List<String> list = new ArrayList<String>();	// 뒤에 ArrayList<> 안에 클래스 이름은 생략 가능
		
		//리스트 원소 추가
		list.add("Java");		// "Java" 값을 가진 String 객체를 0번쩨 인덱스에 추가 및 저장
		list.add("JDBC");		// "JDBC" 값을 가진 String 객체를 1번쩨 인덱스에 추가 및 저장
		list.add("Servlet/JSP");// "Servlet/JSP" 값을 가진 String 객체를 2번쩨 인덱스에 추가 및 저장
