...
public class StringGetBytesExample {
	public static void main(String[] args) {
		String str1 = "안녕하세요";	// 안 -> ㅇㅏㄴ 3byte, ㅎㅏ_ -> 3byte
		...
		try {
			// euc-kr(대소문자 구분 안 함) -> 한국어 인코딩 타입 이름
			...
			// utf-8(대소문자 구분 안 함) -> 다(多)국어 인코딩 타입 이름
			byte[] bytes4 = str1.getBytes("utf-8");	// utf-8로 인코딩 utf-8은 2byte ex) 아ㄴ -> 2byte
			System.out.println("bytes4.length: " + bytes4.length);	// 2byte * 5 -> 10개
