...
/**
 * desc: buffered 한 거와 안 한 거의 성능 차이 비교
 */

public class NonBufferVsBufferExample {
	public static void main(String[] args) throws Exception {
		//buffered 를 사용하지 않고 copy
		//copy 할 파일의 path 가져오기
		...
		System.out.println("버퍼르 사용하지 않았을 때:\t" + nonBufferElaspTime + "ns");
		...
		// 복사 대상의 파일의 path세팅
		String targetFilePath2 = "./bin/sec01/dog2-copy.jpg";
		...
		long nonBufferElaspTime2 = copy(bis, bos);	// 기본 스트림을 사용하여 copy한 시간을 리턴
		System.out.println("버퍼르 사용했을 때:\t" + nonBufferElaspTime2 + "ns");
